		...
		$(document).ready(function() {
			$('#toggle-info').on('click', function(e) {
				...
				if ($additionalInfo.is(':visible')) {
					...
					$(this).text('Continue Reading'); // Change button text
				} else {
					$additionalInfo.slideDown();
					$(this).text('Show Less'); // Change button text
				}
			});
		});
		$(document).ready(function() {
			$('.carousel article').on('click', function() {
				// Remove highlight from all articles
				$('.carousel article').removeClass('highlighted');
